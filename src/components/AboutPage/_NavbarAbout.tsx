                ...
                <div className="aside-dropdown__inner"><span className="aside-dropdown__close">
                    ...
                    <div className="aside-dropdown__item d-lg-none d-block">
                        <ul className="aside-menu">
                            <li className="aside-menu__itsem aside-menu__item--has-child"><a className="aside-menu__link" href="javascript:void(0);"><span>Home</span></a>
                            ...
                            <li className="aside-menu__item aside-menu__item--has-child aside-menu__item--active"><a className="aside-menu__link" href="javascript:void(0);"><span>Pages</span></a>
                                <ul className="aside-menu__sub-list">
                                    <li className="item--active"><a href="about.html"><span>About</span></a></li>
                ...
                <div className="container-fluid">
                    <div className="row no-gutters justify-content-between">
                        <div className="col-auto d-flex align-items-center">
                            ...
                            <div className="header-logo"><a className="header-logo__link" href="index.html"><img className="header-logo__img" src="img/logo_dark.png" alt="logo" /></a></div>
                        </div>
