	...
	return (
		<main className="main">
			<section className="promo-primary">
				<picture>
					<source srcSet="img/causes.jpg" media="(min-width: 992px)" /><img className="img--bg" src="img/causes.jpg" alt="img" />
				</picture>
						...
						<div className="col-auto">
							<div className="align-container">
								<div className="align-container__item"><span className="promo-primary__pre-title">Helpo</span>
									<h1 className="promo-primary__title"><span>Our</span> <span>Causes</span></h1>
								</div>
							</div>
						</div>
					</div>
						...
						<div className="col-md-6 col-lg-4">
							<div className="causes-item causes-item--primary">
								<div className="causes-item__body">
									...
									<div className="causes-item__img">
										<div className="causes-item__badge" style="background-color: #F36F8F">Medicine</div><img className="img--bg" src="img/causes_2.jpg" alt="img" />
									</div>
									<div className="causes-item__lower">
										<div className="progress-bar">
						...
						<div className="col-md-6 col-lg-4">
							<div className="causes-item causes-item--primary">
								<div className="causes-item__body">
									...
									<div className="causes-item__lower">
										<div className="progress-bar">
											<div className="progress-bar__inner" style="width: 42%;">
						...
						<div className="col-md-6 col-lg-4">
							<div className="causes-item causes-item--primary">
								<div className="causes-item__body">
									...
									<div className="causes-item__img">
										<div className="causes-item__badge" style="background-color: #49C2DF">Water Delivery</div><img className="img--bg" src="img/causes_5.jpg" alt="img" />
									</div>
									<div className="causes-item__lower">
										<div className="progress-bar">
											<div className="progress-bar__inner" style="width: 65%;">
						...
						<div className="col-md-6 col-lg-4">
							<div className="causes-item causes-item--primary">
								<div className="causes-item__body">
									...
									<div className="causes-item__img">
										<div className="causes-item__badge" style="background-color: #2EC774">Education</div><img className="img--bg" src="img/causes_6.jpg" alt="img" />
									</div>
									<div className="causes-item__lower">
										<div className="progress-bar">
											<div className="progress-bar__inner" style="width: 95%;">
