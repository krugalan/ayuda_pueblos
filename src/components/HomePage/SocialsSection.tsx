    ...
    return (
        <div>
            <section className="section instagram no-padding-bottom">
                ...
                <div className="instagram-slider"><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_1.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_2.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_3.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_4.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_5.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_6.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a><a className="instagram-slider__item" href="#"><img className="img--bg" src="img/ig_4.jpg" alt="img" /><span className="instagram-slider__icon"><i className="fa fa-instagram" aria-hidden="true"></i></span><span className="instagram-slider__icon-hover"><i className="fa fa-instagram" aria-hidden="true"></i></span></a></div>
            </section>
        </div>
    )
}
