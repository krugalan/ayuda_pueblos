                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-xl-5 offset-xl-1">
                            <div className="info-box"><img className="img--layout" src="../src/assets/img/about_layout.png" alt="img" />
                                <img className="img--bg" src="../src/assets/img/about-us.jpg" alt="img" />
